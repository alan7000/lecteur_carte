 ...
 * @author alan
 */
public class AddBorneDlg extends javax.swing.JDialog {
    ...
    /**
     * Creates new form AddBorneDlg
     *
     * @param parent
     * @param modal
     */
    public AddBorneDlg(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public AddBorneDlg(JFrame parent, boolean modal, Borne borne) {
        super(parent, modal);
        initComponents();
        this.id = borne.getId();
    ...
    private void jButtonOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOkActionPerformed
        String idSalle = this.jComboBox1.getSelectedItem().toString();
        ...
        this.borne.setSalle(salle);

        this.borne.setId(this.id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddBorneDlg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                AddBorneDlg dialog = new AddBorneDlg(new javax.swing.JFrame(), true);
